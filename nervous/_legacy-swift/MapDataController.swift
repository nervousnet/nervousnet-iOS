...
//        
//        let fetchResults:NSArray = (try? managedObjectContext!.executeFetchRequest(fetchRequest)) as NSArray!
//        
//        if(fetchResults.count == 1){
...
//
//        let fetchResults = (try? managedObjectContext!.executeFetchRequest(fetchRequest)) as NSArray!
//        
//        
//        return fetchResults
//        
...
//            
//            var nodeResult:NSArray! = (try? managedObjectContext!.executeFetchRequest(nodeRequest)) as NSArray!
//            
