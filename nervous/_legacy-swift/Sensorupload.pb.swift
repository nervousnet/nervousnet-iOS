...
//    return size
//  }
//  class func parseFromData(data:[UInt8]) -> SensorUpload {
//    return SensorUpload.builder().mergeFromData(data).build()
//  }
//  class func parseFromData(data:[UInt8], extensionRegistry:ExtensionRegistry) -> SensorUpload {
...
//      return size
//    }
//    class func parseFromData(data:[UInt8]) -> SensorUploadSensorData {
//      return SensorUploadSensorData.builder().mergeFromData(data).build()
//    }
//    class func parseFromData(data:[UInt8], extensionRegistry:ExtensionRegistry) -> SensorUploadSensorData {
...
//      let returnMe:SensorUploadSensorData = result
//      return returnMe
//    }
...
//      let unknownFieldsBuilder:UnknownFieldSetBuilder = UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
//      while (true) {
...
//            let limit:Int32 = input.pushLimit(length)
...
//      let returnMe:SensorUpload = result
//      return returnMe
//    }
...
//          }
//          else if tag == 42 {
//            let subBuilder = SensorUploadSensorData.builder()
