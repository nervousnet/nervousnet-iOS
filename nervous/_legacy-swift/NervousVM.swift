...
//        
//        let sensorDataArray: [SensorUploadSensorData] =
...
//        let currentTimeB :NSDate = NSDate()
//        var isCharging: Bool
...
//            isAcCharge = false
//        }
//        let sensorDescBat = SensorDescBattery (
...
//        let currentTimeP :NSDate = NSDate()
//        let sensorDescProx = SensorDescProximity (
...
//        // println("+=+=+=+=+=+=+=+=+=+=+=+=+=+=")
//        // UUID
//        let huuid : UInt64 = getHUUID()
//        let luuid : UInt64 = getLUUID()
//        
//        let db = SQLiteSensorsDB.sharedInstance
//        let currentTime :NSDate = NSDate()
//        let timestamp :UInt64 = UInt64(currentTime.timeIntervalSince1970*1000)
//        //println(VM.getHUUID())
//        
//        // Accelerometer
//        if(self.shareA) {
...
//            let sensorDataArrayA: [SensorUploadSensorData] = db.retrieve(0x0000000000000000, fromTimestamp: (timestamp - 60000), toTimestamp: timestamp)
...
//            let sensorDataArrayG: [SensorUploadSensorData] = db.retrieve(0x0000000000000002, fromTimestamp: (timestamp - 60000), toTimestamp: timestamp)
...
//            let sensorDataArrayM: [SensorUploadSensorData] = db.retrieve(0x0000000000000005, fromTimestamp: (timestamp - 60000), toTimestamp: timestamp)
...
//            let sensorDataArrayB: [SensorUploadSensorData] = db.retrieve(0x0000000000000001, fromTimestamp: (timestamp - 60000), toTimestamp: timestamp)
...
//            let sensorDataArrayP: [SensorUploadSensorData] = db.retrieve(0x0000000000000006, fromTimestamp: (timestamp - 60000), toTimestamp: timestamp)
