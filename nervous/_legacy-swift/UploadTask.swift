...
//        let serverAddress = VM.getServerAddress()
//        let serverPort = VM.getServerPort()
//        
...
//            let inp:NSInputStream = self.inputStream!
//            let out:NSOutputStream = self.outputStream!
//            
//            // set delegate
//            inp.delegate = self
//            out.delegate = self
...
//    
//    func writeToRouter(){
//            let sensorData :SensorUpload = self.pbSensorupload!
//            let out :NSOutputStream = self.outputStream!
//            let inp :NSInputStream = self.inputStream!
//            let date = NSDate()
//        
