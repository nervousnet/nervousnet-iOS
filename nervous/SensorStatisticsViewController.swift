...
class SensorStatisticsViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        var timestamp = UInt64(currentTimeA.timeIntervalSince1970*1000)
