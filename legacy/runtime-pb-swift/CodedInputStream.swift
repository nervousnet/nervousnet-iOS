...
//    
//    
//    func readRawData(var size:Int32) -> [UInt8] {
//        if (size < 0) {
...
//            var chunks:Array<Array<UInt8>> = Array<Array<Byte>>()
//            
//            while (sizeLeft > 0) {
//                var chunk:[UInt8] = [Byte](count:Int(min(sizeLeft, BUFFER_SIZE)), repeatedValue: 0)
//                
//                
//                var pos:Int = 0
...
//            
//            
//            var bytes:[UInt8] = [Byte](count: Int(size), repeatedValue: 0)
...
//            
//            while (pos < size) {
//                var data:[UInt8] = [Byte](count: Int(size - pos), repeatedValue: 0)
//                
//                var n:Int = 0
//                
//                if input == nil
...
//    {
//        let wireFormat = WireFormat.wireFormatGetTagFieldNumber(tag)
...
//    {
//        let convert:Int64 = readRawLittleEndian64()
//        var result:Double = 0
...
//    {
//        let convert:Int32 = readRawLittleEndian32()
//        var result:Float = 0
//        WireFormat.convertTypes(convertValue: convert, retValue: &result)
//        return result
//    }
...
//    
//    
//  /* REMOVED THIS FUNCTION. IF YOU WANT STRINGS IN PROTOBUF, FIX THIS FIRST.
//    
...
//        if (size < bufferSize - bufferPos && size > 0)
//        {
//            var result:[UInt8] = [Byte](count: Int(size), repeatedValue: 0)
