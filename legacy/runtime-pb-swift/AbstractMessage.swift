...
//    func mergeFromData(data:[UInt8]) -> Self
//    func mergeFromData(data:[UInt8], extensionRegistry:ExtensionRegistry) -> Self
...
//    return true;
//}
//class AbstractMessage:Equatable, CustomStringConvertible, Message {
//    
...
//    func mergeUnknownFields(unknownField:UnknownFieldSet) -> Self
//    {
//        let merged:UnknownFieldSet = UnknownFieldSet.builderWithUnknownFields(unknownFields).mergeUnknownFields(unknownField).build()
