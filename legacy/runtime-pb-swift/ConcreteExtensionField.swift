...
//        case .ExtensionTypeBytes:
//            output.writeData(fieldNumber, value:(value as [UInt8]))
//        case .ExtensionTypeString:
...
//        case .ExtensionTypeBytes:
//            output.writeDataNoTag((value as [UInt8]))
//        case .ExtensionTypeString:
...
//        case .ExtensionTypeBytes:
//            return WireFormat.computeDataSize(fieldNumber, value: (value as [UInt8]))
//        case .ExtensionTypeString:
...
//        case .ExtensionTypeBytes:
//            return WireFormat.computeDataSizeNoTag((value as [UInt8]))
//        case .ExtensionTypeString:
...
//        // IF YOU RE-ENABLE THE STRING FUNCTION FOR PROTOBUFS, UNCOMMENT THIS
//        /* case .ExtensionTypeString:
