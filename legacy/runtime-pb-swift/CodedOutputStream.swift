...
//    
//    init (output aOutput:NSOutputStream?, data:[UInt8])
//    {
//        output = aOutput
...
//    }
//   
//    func writeRawByte(byte aByte:UInt8)
//    {
...
//    }
//    
//    func writeRawData(data:[UInt8])
//    {
//        writeRawData(data, offset:0, length: Int32(data.count))
//    
//    }
//    func writeRawData(data:[UInt8], var offset aOffset:Int32, var length aLength:Int32)
//    {
//        while (aLength > 0)
//        {
...
//    }
//    
//    func writeDataNoTag(data:[UInt8]?)
//    {
//        writeRawVarint32(Int32(data!.count))
//        writeRawData(data!)
//    }
//    
//    func writeData(fieldNumber:Int32, value:[UInt8]?)
//    {
//        writeTag(fieldNumber, format: WireFormat.WireFormatLengthDelimited)
...
//        writeUInt32(WireFormatMessage.WireFormatMessageSetTypeId.rawValue, value:fieldNumber)
...
//    }
//    
//    func writeRawMessageSetExtension(fieldNumber:Int32, value:[UInt8]?)
//    {
//        writeTag(WireFormatMessage.WireFormatMessageSetItem.rawValue, format:WireFormat.WireFormatStartGroup)
//        writeUInt32(WireFormatMessage.WireFormatMessageSetTypeId.rawValue, value:fieldNumber)
