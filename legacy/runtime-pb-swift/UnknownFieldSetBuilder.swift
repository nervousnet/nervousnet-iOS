...
//    
//    
//    func mergeFromData(data:[UInt8]) -> UnknownFieldSetBuilder
//    {
...
//    }
//    
//    func mergeFromData(data:[UInt8], extensionRegistry:ExtensionRegistry) ->UnknownFieldSetBuilder
//    {
